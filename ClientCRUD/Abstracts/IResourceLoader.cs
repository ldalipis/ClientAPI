...
namespace ClientCRUD.Abstracts
{
    public interface IResourceLoader
    {
        ...
        Task<IEnumerable<IUnifiedResponseModel>> GetAllAsync(CancellationToken cancellationToken = default);
        ...
        Task<IUnifiedResponseModel> GetByIdAsync(string id, CancellationToken cancellationToken = default);
        ...
        Task AddAsync(IUnifiedRequestModel request, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Optional cancellation token.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task UpdateAsync(IUnifiedRequestModel request, CancellationToken cancellationToken = default);
